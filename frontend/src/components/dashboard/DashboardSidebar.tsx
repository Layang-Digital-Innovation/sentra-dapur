      ...
      <div className={`hidden md:fixed md:inset-y-0 md:flex md:flex-col md:top-16 transition-all duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full bg-white border-r border-gray-200 shadow-sm">
          ...
          <div className="relative flex-1 min-h-0">
            ...
            >
              {/* Logo and Brand */}
              <div className={`flex flex-shrink-0 items-center mb-6 pt-2 ${isCollapsed ? 'justify-center px-2' : 'justify-start px-6'}`}>
                <Logo className={isCollapsed ? "h-10" : "h-12 -ml-2"} showText={!isCollapsed} />
              </div>
