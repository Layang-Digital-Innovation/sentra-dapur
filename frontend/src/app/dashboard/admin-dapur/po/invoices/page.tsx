...
export default function AdminDapurInvoicesPage() {
  ...
  const handleDeletePO = async (poId: string) => {
    if (!confirm("Apakah Anda yakin ingin menghapus Invoice PO ini? Data yang terhapus tidak dapat dikembalikan.")) return;
    try {
      await dapurService.deletePurchaseOrder(poId);
      alert("Invoice PO berhasil dihapus.");
      fetchData();
    } catch (err: any) {
      alert(err.message || "Gagal menghapus Invoice PO");
    }
  };
