    ...
    container.innerHTML = `
      <div style="display: flex; align-items: center; gap: 20px; margin-bottom: 24px;">
        ...
        <div>
          ...
          <div style="color: #6b7280; font-size: 14px; max-width: 500px;">${dapurUnit?.fullAddress || 'Sistem Manajemen Cloud Kitchen Terpadu'}</div>
        </div>
      </div>
      ...
      <div style="display: flex; justify-content: flex-end; margin-top: 50px;">
        <div style="text-align: center; width: 200px;">
          <div style="font-size: 12px; margin-bottom: 40px; color: #4b5563;">Hormat Kami,</div>
          ${signatureHtml}
